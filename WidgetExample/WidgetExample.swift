...
//  WidgetExample
//
//  Created by Luka Vujnovac on 10.10.2021..
//
...
//        Text(entry.date, style: .time)
        ...
        GeometryReader { geometry in 
            ZStack{
                LinearGradient(colors: [Color.pink, Color.blue],
...
struct WidgetExample: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .description("This is an example widget for the personal task menager")
    }
}
